<template>
  <div class="view d-flex">
    ...
    <div class="area-visivel animacao-opacidade-sombra-ligeira d-flex">
      <div
        class="area-conteudo ajuste-f animacao-opacidade-sombra-ligeira d-flex justify-content-start fundo-f4 borda-r5 sombra-ligeira"
      >
        <div class="area-utilizador d-flex padding-all8">
          <div class="area-utilizador-perfilenotificacoes">
            <div class="area-perfil">
              <label
                class="area-label fonte-24 mukta-m cor-20 padding-l8 sem-margens"
                for="perfil-conteudo"
                >Perfil do utilizador</label
              >
              <div
                class="area-perfil-conteudo d-flex justify-content-between fundo-ff borda-fina borda-aa borda-r5"
                name="perfil-conteudo"
              >
                <div class="info-perfil-utilizador d-flex flex-wrap-start">
                  <div class="area-foto-perfil-utilizador">
                    <img
                      :src="obterInfoUtilizador.foto"
                      class="foto-perfil borda-grossa borda-70 borda-r5"
                      alt="Imagem de perfil do utilizador"
                    />
                  </div>
                  <div
                    class="area-dados-perfil-utilizador d-flex flex-wrap align-content-between margem-y8"
                  >
                    <div class="nome-e-tipo-utilizador">
                      <p
                        class="fonte-24 opensans-sb cor-20 sem-margens text-left"
                      >
                        {{
                          obterInfoUtilizador.nome +
                          " " +
                          obterInfoUtilizador.apelido
                        }}
                      </p>
                      <p class="fonte-14 mukta-l cor-40 sem-margens text-left">
                        ({{
                          this.$store.getters.obterTipoUtilizadorePorId(
                            obterInfoUtilizador.id_tipo
                          )
                        }})
                      </p>
                    </div>
                    <div
                      v-if="obterInfoUtilizador.id_tipo == 1"
                      class="area-documentos"
                    >
                      <label
                        class="d-flex justify-content-start fonte-16 mukta-m cor-20 sem-margens"
                        for="documentos"
                        >Documentos</label
                      >
                      <div
                        class="documentos-utilizador fundo-f4 borda-r5"
                        id="documentos"
                      >
                        <div
                          class="opcao-documento d-flex flew-wrap align-items-center padding-all4"
                        >
                          <svg
                            id="svg_documento"
                            data-name="Layer 1"
                          ...
                          >
                            <path
                              class="cls-1"
                              d="M25.9,41.6H23.2v7.7h2.2a12.31,12.31,0,0,0,2-.2,3.82,3.82,0,0,0,1.6-.6,4.26,4.26,0,0,0,1.1-1.2,3.58,3.58,0,0,0,.4-1.9,3.24,3.24,0,0,0-1.3-2.9A5.6,5.6,0,0,0,25.9,41.6Z"
                            />
                            <path
                              class="cls-1"
                              d="M48.2,41.6H45.6V58.3h1.9a12.42,12.42,0,0,0,3.3-.4,8.18,8.18,0,0,0,2.8-1.4,7.72,7.72,0,0,0,1.9-2.7,10.75,10.75,0,0,0,.7-4.3c0-2.5-.7-4.5-2.2-5.8A7.94,7.94,0,0,0,48.2,41.6Z"
                            />
                            <path
                              class="cls-1"
                              d="M90,0H10A10,10,0,0,0,0,10V90a10,10,0,0,0,10,10H90a10,10,0,0,0,10-10V10A10,10,0,0,0,90,0ZM35.4,48.8a7.84,7.84,0,0,1-2.2,2.6A8.59,8.59,0,0,1,30,52.9a16,16,0,0,1-3.9.5H23.2v9.2H17.7V37.4h8.8a16.2,16.2,0,0,1,4,.5,8.45,8.45,0,0,1,3,1.5,6.34,6.34,0,0,1,1.9,2.4,8.05,8.05,0,0,1,.7,3.3A7,7,0,0,1,35.4,48.8Zm25.4,6.6a12.44,12.44,0,0,1-3,4.1,12.21,12.21,0,0,1-4.5,2.4,19.22,19.22,0,0,1-5.5.8H40.1V37.4h8.8a17.85,17.85,0,0,1,5.3.8,10.94,10.94,0,0,1,4.1,2.3A11.87,11.87,0,0,1,61,44.3a14.35,14.35,0,0,1,.9,5.3A12,12,0,0,1,60.8,55.4ZM82.3,41.6H71.8v6.7h9.6v4.2H71.8V62.6H66.3V37.4h16Z"
                            />
                          </svg>
                          <p
                            class="fonte-12 mukta-r cor-40 sem-margens padding-l4"
                          >
                            Currículo
                          </p>
                        </div>
                    ...
                    <div class="area-redes-sociais-e-portfolio">
                      <label
                        class="d-flex justify-content-start fonte-16 mukta-m cor-20 sem-margens"
                        for="botoes-rsep"
                        >Redes sociais e Portfólio</label
                      >
                      <div
                        ...
                        <a :disabled="botoes.email" @click="alert(botoes.email)" target="_blank"
                          ...
                          >
                            ...
                            >
                              ...
                              <path
                                class="cls-2"
                                d="M10,9.4,0,6.3V4.5L10,7.6,20,4.5v-2a2,2,0,0,0-2-2H2a2,2,0,0,0-2,2v15a2,2,0,0,0,2,2H18a2,2,0,0,0,2-2V6.3Z"
                                transform="translate(0 -0.5)"
                              />
                            </svg></div
                        ></a>
                ...
                <div class="area-desconectar">
                  <button
                    @click="desconectar"
                    class="texto-desconectar fonte-16 opensans-sb"
                  >
                    <div class="botao-desconectar d-flex align-items-center">
                      Desconectar
                    </div>
                  </button>
                </div>
            ...
            <div class="area-notificacoes">
              <label
                class="area-label fonte-24 mukta-m cor-20 padding-l8 sem-margens"
                for="notificacoes-conteudo"
                >Notificações</label
              >
              <div
                class="area-notificacoes-conteudo fundo-ff borda-fina borda-aa borda-r5"
                name="notificacoes-conteudo"
              >
                <table class="tabela borda-grossa borda-70 borda-r5 cor-20">
                  ...
                  <tr
                    v-for="notificacao in obterTabelaNotificacoes"
                    :key="notificacao.id"
                  >
          ...
          <div class="area-definicoes">
            <label
              class="area-label fonte-24 mukta-m cor-20 padding-l8 sem-margens"
              for="definicoes-conteudo"
              >Definições</label
            >
            <div
              class="area-definicoes-conteudo fundo-ff borda-fina borda-aa borda-r5"
              name="definicoes-conteudo"
            >
              <form @submit.prevent="editarPerfil" @reset="anular">
                <label
                  class="area-label fonte-18 mukta-m cor-20 padding-l8 sem-margens margem-t7"
                  for=""
                  >Alterar a palavra passe</label
                >
                <!-- Input para inserir a atual palavra-passe -->
                <input
                  class="cor-60 fundo-fa fonte-12 opensans-l borda-r5 sem-margens"
                  type="password"
                  v-model="dados.passe_atual"
                ...
                <input
                  class="cor-60 fundo-fa fonte-12 opensans-l borda-r5 sem-margens"
                  type="link"
                  v-model="dados.facebook"
                  placeholder="Insira o link para o seu Facebook"
                />
                <!-- Input para inserir o link do GitHub do utilizador -->
                <input
                  class="cor-60 fundo-fa fonte-12 opensans-l borda-r5 sem-margens margem-t7"
                  type="link"
                  v-model="dados.github"
                ...
                <input
                  class="cor-60 fundo-fa fonte-12 opensans-l borda-r5 sem-margens margem-t7"
                  type="link"
                  v-model="dados.instagram"
                  placeholder="Insira o link para o seu Instagram"
                />
                ...
                <label
                  class="area-label fonte-18 mukta-m cor-20 padding-l8 sem-margens margem-t7"
                  for=""
                  >Portólio do utilizador</label
                >
                <!-- Input para inserir o link do portfólio -->
                <input
                  class="cor-60 fundo-fa fonte-12 opensans-l borda-r5 sem-margens"
                  type="link"
                  v-model="dados.portfolio"
                ...
                <div class="d-flex flex-wrap align-content-end">
                  <button
                    type="submit"
                    class="botao-guardar fundo-40 fonte-16 opensans-sb cor-ee borda-fina borda-20 borda-r5"
                  >
                    Guardar
                  </button>
                  <button
                    type="reset"
                    class="botao-anular fundo-dd fonte-16 opensans-sb cor-20 borda-fina borda-aa borda-r5"
                  >
                    Anular
                  </button>
                </div>
...
.area-utilizador-perfilenotificacoes {
...
.area-perfil-conteudo {
  height: calc(100% - 36px);
}
.area-notificacoes-conteudo {
  height: calc(100% - 36px);
  padding: 8px 8px;
}
.area-definicoes-conteudo {
  height: calc(100% - 36px);
}
.area-label {
  text-align: left;
...
.info-perfil-utilizador {
  height: 100%;
}
.area-foto-perfil-utilizador {
  height: 100%;
  padding: 8px 8px;
}
.foto-perfil {
...
.area-dados-perfil-utilizador {
  padding: 2px 2px;
  width: 338px;
}
.nome-e-tipo-utilizador,
.area-documentos,
.area-redes-sociais-e-portfolio {
  width: 100%;
}
.documentos-utilizador {
  width: 200px;
}
#svg_documento {
  fill: #404040;
...
.opcao-documento #svg_documento {
  transition: fill 0.2s ease-in-out;
}
.opcao-documento p {
  transition: color 0.2s ease-in-out;
}
.opcao-documento:hover #svg_documento {
  fill: #606060;
}
.opcao-documento:hover p {
  color: #606060;
}
.botoes-redes-sociais-e-portfolio {
  height: 50px;
  width: auto;
}
.botao-email,
...
.botao-email:hover > #svg_email,
.botao-facebook:hover > #svg_facebook,
.botao-instagram:hover > #svg_instagram,
.botao-github:hover > #svg_github,
.botao-discord:hover > #svg_discord {
  fill: #ffffff;
}
.botao-portfolio {
  height: 42px;
...
export default {
  ...
  methods: {
    desconectar() {
      this.$store.dispatch("desconectar"), window.location.reload();
    },
    anular() {
      (this.passe_atual = ""),
        (this.dados = {
    ...
    editarPerfil() {
      ...
      if (
        this.dados.passe == "" ||
        (this.dados.passe == this.$data.confirmar_passe_nova &&
          bcrypt.compareSync(this.$data.dados.passe_atual, this.obterInfoUtilizador.passe))
      ) {
        try {
          const dados = {
