<template>
  <div class="container-autenticacao d-flex justify-content-center align-items-center">
    <div class="autenticacao animacao-opacidade-sombra-forte will-change fundo-dd borda-fina borda-70 borda-r10 sombra-forte">
      <div class="container-formulario-autenticacao-registo">
        <form @submit.prevent="autenticacao">
          ...
          <label class="d-flex justify-content-start mukta-m fonte-14 cor-20 sem-margens margem-l5" for="correio">Correio eletrónico</label>
          <input class="fundo-fa opensans-l fonte-12 cor-60 borda-r5 sem-margens" type="email" name="correio"  v-model='autenticacao_utilizador.correio' autocomplete="off"><br>
          <label class="d-flex justify-content-start mukta-m fonte-14 cor-20 sem-margens margem-l5 margem-t7" for="passe">Palavra-passe</label>
          <input class="fundo-fa opensans-l fonte-12 cor-60 borda-r5 sem-margens" :type="type" name="passe" v-model='autenticacao_utilizador.passe'>
          <div class="ver-helper d-flex justify-content-end sem-margens">
            <svg @click="mostrar" class="ver sem-margens cursor-pointer" xmlns="http://www.w3.org/2000/svg" width="16" viewBox="0 0 24 24" xmlns:v="https://vecta.io/nano"><path d="M15 12c0 1.654-1.346 3-3 3s-3-1.346-3-3 1.346-3 3-3 3 1.346 3 3zm9-.449S19.748 19 12.015 19C4.835 19 0 11.551 0 11.551S4.446 5 12.015 5C19.709 5 24 11.551 24 11.551zM17 12a5 5 0 1 0-10 0 5 5 0 1 0 10 0z"/><defs /></svg>
          </div>
          <label class="conteudo-checkbox d-flex justify-content-start align-items-center mukta-r fonte-10 cor-20 sem-margens margem-t15 cursor-pointer">
          ...
          <button class="botao-autenticacao-registo fundo-aa mukta-sb fonte-16 cor-20 borda-r5 margem-t15 cursor-pointer" type="submit">Entrar</button>
        </form>
        <div class="separador d-flex justify-content-start">
          <hr class="linha-separador borda-solida borda-aa sem-margens margem-t15">
            <span class="texto-separador mukta-el fonte-10 cor-80 sem-margens margem-t7 margem-x5 padding-t8">ou</span>
          <hr class="linha-separador borda-solida borda-aa sem-margens margem-t15">
        </div>
        <p class="link-autenticao-registo mukta-l fonte-12 sem-margens"><router-link :to="{name:'Registo'}">Criar um utilizador</router-link></p>
      </div>
    </div>
  </div>
</template>
...
/* Estilização específica a esta página: */
  ...
  .container-autenticacao {
    min-height: 460px; /* Alterar mais tarde 754 */ 
    min-width: 320px; /* Alterar mais tarde */
  }

  @media screen and (max-width: 400px){
    .autenticacao {width: 90%;} 
    .container-formulario-autenticacao-registo {margin: 0px auto;}
  }
</style>
<script>
  export default {
