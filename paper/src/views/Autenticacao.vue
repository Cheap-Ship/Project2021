    ...
    <div class="autenticacao animacao-opacidade-sombra-forte will-change fundo-dd borda-fina borda-70 borda-r10 sombra-forte">
      <div class="container-formulario-autenticacao-registo">
        <form @submit.prevent="autenticacao">
          ...
          <input class="fundo-fa opensans-l fonte-12 cor-60 borda-r5 sem-margens" type="email" id="correio"  v-model='autenticacao_utilizador.correio' autocomplete="off"><br>
          ...
          <input class="fundo-fa opensans-l fonte-12 cor-60 borda-r5 sem-margens" :type="type" id="passe" v-model='autenticacao_utilizador.passe'>
